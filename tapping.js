...
document.body.addEventListener('click', function() {
  ...
  if (tapCount === 25) {
    ...
    alert("Congratulations on tapping the screen 25 times without moving to another page! In the repetition of this seemingly trivial act, you have embarked on a profound journey of self-reflection. Embrace the absurdity of this moment, for it is in the ordinary actions that the extraordinary nature of existence reveals itself.");

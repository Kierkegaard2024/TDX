document.addEventListener('DOMContentLoaded', function () {
  ...
  generateDynamicLinkAndModal("https://copilot.microsoft.com/", "Copilot");
});
...
function generateDynamicLinkAndModal(linkUrl, linkText) {
  ...
  dynamicLink.style.verticalAlign = "middle"; // Add vertical-align style
  dynamicLink.style.color = "#FFFFFF"; // Add color style
  dynamicLink.style.fontSize = "13px"; // Add font-size style
  ...
  dynamicModal.style.zIndex = "1000"; // Set a high z-index value
  ...
  dynamicModalContent.style.zIndex = "1001"; // Set a higher z-index value
